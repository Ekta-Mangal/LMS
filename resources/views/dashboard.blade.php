                                ...
                                @if (Auth::user()->role !== 'Admin')
                                    <div class="row justify-content-center">
                                        <div class="col-md-12 text-center">
                                            <h5>Hey <strong>{{ Auth::user()->name }}</strong>, You are Applicable for QMS
                                                Course on</h5>
                                            @php
                                                $userRole = $role;
                                            @endphp

                                            <p>Kindly Click below on Enroll Option to Start Your Course</p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row text-center">
                                                <div class="col-md-4">
                                                    <a class="btn btn-app bg-olive"
                                                        ...
                                                        <i class="fas fa-database"></i> Course Enrollment
                                                    </a>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <a class="btn btn-app bg-warning"
                                                        style="font-size: 24px; padding: 20px; width: 250px; height: 100px;">
                                                        <span class="badge bg-blue" id="completed_course"
                                                            style="font-size: 18px; padding: 15px 15px;">
                                                            @if (isset($completedUsersCount))
                                                                {{ $completedUsersCount }}
                                                            @endif
                                                        </span>
                                                        <i class="fas fa-check-circle"></i> User’s Completed Course
                                                    </a>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <a class="btn btn-app bg-primary"
                                                        ...
                                                        <i class="fas fa-spinner"></i> User’s Attempting Course
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row text-center mt-3">
                                                <div class="col-md-4">
                                                    <a class="btn btn-app bg-danger"
                                                        style="font-size: 24px; padding: 20px; width: 250px; height: 100px;">
                                                        <span class="badge bg-warning" id="silver_badge"
                                                            style="font-size: 18px; padding: 15px 15px;">
                                                            @if (isset($silverCount))
                                                                {{ $silverCount }}
                                                            @endif
                                                        </span>
                                                        <i class="fas fa-medal"></i> User’s With Silver Badge
                                                    </a>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <a class="btn btn-app bg-info"
                                                        style="font-size: 24px; padding: 20px; width: 250px; height: 100px;">
                                                        <span class="badge bg-dark" id="gold_badge"
                                                            style="font-size: 18px; padding: 15px 15px;">
                                                            @if (isset($goldCount))
                                                                {{ $goldCount }}
                                                            @endif
                                                        </span>
                                                        <i class="fas fa-award"></i> User’s With Gold Badge
                                                    </a>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <a class="btn btn-app bg-purple"
                                                        ...
                                                        <i class="fas fa-trophy"></i> User’s With Platinum Badge
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row text-center mt-3">
                                                <div class="col-md-4 offset-md-4">
                                                    <a class="btn btn-app bg-dark"
                                                        style="font-size: 24px; padding: 20px; width: 250px; height: 100px;">
                                                        <span class="badge bg-danger" id="session_pending"
                                                            style="font-size: 18px; padding: 15px 15px;">
                                                            @if (isset($pendingApprovalCounts))
                                                                {{ $pendingApprovalCounts }}
                                                            @endif
                                                        </span>
                                                        <i class="fas fa-hourglass-half"></i> Session Approval Pending
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
