                            ...
                            <div class="card-body">
                                <div class="row justify-content-center">
                                    <div class="col-md-12 text-center">
                                        <h5><b>Level - 2 Course On QMS & Its Applications</b></h5>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12 text-center">
                                            ...
                                            <div class="card border-secondary mx-auto w-75"
                                                ...
                                                <div class="card-body py-4">
                                                    ...
                                                    <p class="text-dark font-weight-medium">
                                                        You have Achieved <strong>Gold Badge</strong> and Certification of
                                            ...
                                            @if ($upgrade === 'Waiting')
                                                <div class="card border-info mx-auto w-75 mt-4"
                                                    ...
                                                    <div class="card-body py-4">
                                                        <p class="h4 font-weight-bold text-dark">
                                                            🎯 You are Eligible for L3 Course on QMS & ITS Application.
                                                        </p>
                                            ...
                                            @elseif($upgrade === 'Declined')
                                                <div class="card border-danger mx-auto w-75 mt-4"
                                                    ...
                                                    <div class="card-body py-4">
                                                        <p class="h4 font-weight-bold text-dark">
                                                            ❌ Your Upgrade Request for L3 Course on QMS & ITS Application
                                                            has been Rejected.
                                                        </p>
                                                        <!-- Buttons in one row with proper gap -->
                                                        <div class="d-flex justify-content-center mt-3">
