                            ...
                            <div class="card-body">
                                <div class="row justify-content-center">
                                    <div class="col-md-12 text-center">
                                        <h5><b>Level - 3 Course On QMS & Its Applications</b></h5>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12 text-center">
                                            ...
                                            <div class="card border-secondary mx-auto w-75"
                                                ...
                                                <div class="card-body py-4">
                                                    ...
                                                    <p class="text-dark font-weight-medium">
                                                        You have Achieved <strong>Platinum Badge</strong> and Certification
                                                        of
                                            ...
                                            @if ($upgrade === 'Waiting')
                                                <div class="card border-info mx-auto w-75 mt-4"
                                                    ...
                                                    <div class="card-body py-4">
                                                        <p class="h4 font-weight-bold text-dark">
                                                            🎯 You are Eligible for Platinum Badge.
                                                        </p>
                                            ...
                                            @elseif($upgrade === 'Declined')
                                                <div class="card border-danger mx-auto w-75 mt-4"
                                                    ...
                                                    <div class="card-body py-4">
                                                        <p class="h4 font-weight-bold text-dark">
                                                            ❌ Your Upgrade Request for Platinum Badge has been Rejected.
                                                        </p>
                                                        <!-- Buttons in one row with proper gap -->
                                                        <div class="d-flex justify-content-center mt-3">
                                            ...
                                            @elseif($upgrade === 'Completed')
                                                <div class="card border-success mx-auto w-75 mt-4"
                                                    style="background-color: #e6ffe6;">
                                                    <div class="card-body py-4">
                                                        <p class="h4 font-weight-bold text-dark">
                                                            ✅ Good Job! All the courses are completed.
                                                        </p>
                                                    </div>
                                                </div>
                                            @else
