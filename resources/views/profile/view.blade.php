                                            ...
                                            <div class="card card-primary card-outline">
                                                <div class="card-body">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-md-3 text-center">
                                                            <div class="position-relative d-inline-block">
                                                                @if ($user->badge_level == 'Silver' && $user->upgrade_level_status == 'Completed')
                                                                    <img src="{{ asset('images/Silver.png') }}"
                                                                        alt="Silver Badge" class="img-fluid badge-img">
                                                                @elseif ($user->badge_level == 'Gold')
                                                                    @if ($user->upgrade_level_status == 'Pending' || $user->upgrade_level_status == 'Waiting')
                                                                        <img src="{{ asset('images/Silver.png') }}"
                                                                            alt="Silver Badge" class="img-fluid badge-img">
                                                                    @else
                                                                        <img src="{{ asset('images/Silver.png') }}"
                                                                        ...
                                                                        <img src="{{ asset('images/Gold.png') }}"
                                                                            alt="Gold Badge" class="img-fluid badge-img">
                                                                    @endif
                                                                @elseif ($user->badge_level == 'Platinum')
                                                                    @if ($user->upgrade_level_status == 'Pending' || $user->upgrade_level_status == 'Waiting')
                                                                        <img src="{{ asset('images/Silver.png') }}"
                                                                            alt="Silver Badge" class="img-fluid badge-img">
                                                                        <img src="{{ asset('images/Gold.png') }}"
